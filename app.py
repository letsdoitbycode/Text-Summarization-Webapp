...
def summarize():
    ...
    if request.method == "POST":
        ...
        tokenized_text = tokenizer.encode(input_text, return_tensors='pt', max_length=1000).to(device)
        summary_ = model.generate(tokenized_text, min_length=30, max_length=400)
